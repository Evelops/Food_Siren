...
public class TipActivity extends AppCompatActivity {
    ...
    private void InitializeView() {
        et_foodName = findViewById(R.id.TipActivity_et_food_name);
        ...
        btn_recipe = findViewById(R.id.TipActivity_btn_recipe);
    ...
    private void InitializeListener() {
        ...
        btn_recipe.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra("식자재명", et_foodName.getText().toString());
                startActivity(intent);
            }
        });
