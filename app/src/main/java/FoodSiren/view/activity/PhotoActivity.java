...
public class PhotoActivity extends AppCompatActivity {
    ...
    final static int REQUEST_LOAD_PHOTO = 3;
    ...
    private void InitializeView() {
        ...
        btn_loadPhoto = findViewById(R.id.PhotoActivity_btn_load_photo);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent intent) {
        ...
        if (requestCode == REQUEST_LOAD_PHOTO && resultCode == RESULT_OK && intent != null && intent.getData() != null) {
